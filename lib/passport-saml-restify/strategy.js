...
Strategy.prototype.authenticate = function (req, options) {
  ...
  if (req.params && req.params.SAMLResponse) {
      this._saml.validatePostResponse(req.params, validateCallback);
  } else if (req.params && req.params.SAMLRequest) {
      this._saml.validatePostRequest(req.params, validateCallback);
  } else {
    var operation = {
